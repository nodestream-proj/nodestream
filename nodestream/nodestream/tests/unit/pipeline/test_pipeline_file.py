...
def test_basic_file_load():
    loader = PipelineFile(
        Path("nodestream/nodestream/tests/unit/pipeline/fixtures/simple_pipeline.yaml")
    )
...
def test_basic_file_load_with_annotations():
    loader = PipelineFile(
        Path("nodestream/nodestream/tests/unit/pipeline/fixtures/tagged_pipeline.yaml")
    )
...
def test_pipeline_file_loads_lazy():
    file_contents = PipelineFileContents.read_from_file(
        Path("nodestream/nodestream/tests/unit/pipeline/fixtures/config_pipeline.yaml")
    )
    assert_that(
