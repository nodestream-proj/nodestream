...
class MultiNodeKeySearchAlgorithm(RelatedNodeKeySearchAlgorithm):
    def get_related_node_key_sets(self, context: InterpreterContext):
...
class RelationshipInterpretation(Interpretation, alias="relationship"):
    ...
    def find_relationship(self, context: InterpreterContext) -> Relationship:
    ...
    def find_related_nodes(self, context: InterpreterContext) -> Iterable[Node]:
