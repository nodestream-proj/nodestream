...
def test_project_from_with_with_targets():
    result = Project.read_from_file(
        Path("nodestream/tests/unit/project/fixtures/simple_project_with_targets.yaml")
    )
...
def test_project_from_file_with_config(add_env_var):
    file_name = Path(
        "nodestream/tests/unit/project/fixtures/simple_project_with_config.yaml"
    )
...
def test_project_from_file_with_config_targets(add_env_var):
    result = Project.read_from_file(
        Path(
            "nodestream/tests/unit/project/fixtures/simple_project_with_config_targets.yaml"
        )
    )
    assert_that(
...
def test_project_from_file():
    file_name = Path("nodestream/tests/unit/project/fixtures/simple_project.yaml")
...
def test_project_from_file_missing_file():
    file_name = Path("nodestream/tests/unit/project/fixtures/missing_project.yaml")
...
def test_project_load_lifecycle_hooks_calls_all_hooks_on_all_plugins(mocker):
    ...
    file_path = Path("nodestream/tests/unit/project/fixtures/simple_project.yaml")
